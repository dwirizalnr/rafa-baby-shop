                        ...
                        <div id="storeCarousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="/images/slide-1.jpg" alt="Carousel Image" class="d-block w-100">
                                </div>
                    ...
                    background-color: #eee; @endif">
                                            @if ($product->product_stocks->sum('stock') <= 0)
                                                <div class="text-center"
                                                    style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 38px; font-weight: bold; color: red;">
                                                    Stock Kosong</div>
                                            @endif
                                        </div>
                                    </div>
    ...
    <section class="store-new-products">
        <div class="container">
            ...
            <div class="row">
                ...
                @forelse ($productstrend as $product)
                    <div class="col-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="{{ $incrementProduct += 100 }}">
                        <a href="{{ route('detail', $product->slug) }}" class="component-products d-block">
                            <div class="products-thumbnail">
                                <div class="products-image"
